...
//      Setting both percentage and fraction
    ...
    public ClientDto updateClient(String clientId, ClientDto clientDto) {
        try {
            ...
            String oldStatus = clientEntity.getClientStatus().name();
            ...
            String newStatus = updatedClient.getClientStatus().name();
            ...
            if (!newStatus.equals(oldStatus)) {
                ...
                history.setOldStatus(Statuses.valueOf(oldStatus));
                history.setNewStatus(Statuses.valueOf(newStatus));
            ...
            List<ClientStatusHistoryDto> historyDtos = historyList.stream()
                    .map(history -> {
                        ...
                        dto.setOldStatus(history.getOldStatus() != null ? history.getOldStatus().name() : "N/A");
                        dto.setNewStatus(history.getNewStatus() != null ? history.getNewStatus().name() : "N/A");
